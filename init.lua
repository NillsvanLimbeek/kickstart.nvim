...
-- BASIC KEYMAPS
-- vertical split on the window with |
...
vim.keymap.set('n', '<leader>s?', require('telescope.builtin').oldfiles,
  { desc = '[S]earch [?] for recently opened files' })
vim.keymap.set('n', '<leader>s<space>', require('telescope.builtin').buffers,
  { desc = '[S]earch [ ] for existing buffers' })
